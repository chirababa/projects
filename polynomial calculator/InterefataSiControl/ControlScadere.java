...
/**
 * Created by chira on 14.03.2018.
 */
class ControlScadere implements ActionListener {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        {
            Gui.rezultat.setText(testare.afisarePolinom(testare.scadere(testare.extract(testare.regexVerif(Gui.polinom1.getText())),testare.extract(testare.regexVerif(Gui.polinom2.getText())))));
        }
        else{
