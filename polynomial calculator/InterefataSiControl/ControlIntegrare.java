 ...
 */
class ControlIntegrare implements ActionListener {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        if (testare.regexVerif(Gui.polinom1.getText()) != null) {
            Gui.rezultat.setText(testare.afisarePolinom(testare.integrare(testare.extract(testare.regexVerif(Gui.polinom1.getText())))));
        }
        else{
